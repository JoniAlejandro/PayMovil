...
import com.example.paymovil.pasajero.InicioFragment
import com.google.firebase.firestore.FirebaseFirestore


class AgregarTarjetaCondcutorFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View?{
        ...
        val componentFragment = inflater.inflate(R.layout.fragment_agregar_tarjeta_condcutor, container, false)
        ...
        btnAgregar.setOnClickListener{
            ...
            if (email != null && tNombre.toString().isNotEmpty() && tNumero.toString().isNotEmpty()) {
                db.collection("conductor").document(""+ email).collection("tarjetas").document().set(
